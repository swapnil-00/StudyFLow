...
window.Pages.renderLanding = function renderLanding(container) {
...
window.Pages.renderSeatMap = function renderSeatMap(container, params = {}) {
  const branchId = store.getActiveBranchId();
  const branch = store.getBranch(branchId);
...
window.Pages.renderLayoutEditor = function renderLayoutEditor(container, params = {}) {
...
// ── Router ─────────────────────────────────────────────────────────
const routes = {
  '/landing': () => Promise.resolve(window.Pages.renderLanding),
